...
image: https://eo-r2.afo.im/myblog/img/ee0efba8-8c27-449f-86d0-3e9367d12463.webp
tags: [Mortix, 下载器]
category: '教程'
draft: false 
lang: ''
...
![](https://eo-r2.afo.im/myblog/img/6a10d31c-0c39-456c-8402-ff3190a80dcc.webp)

# 配置Motrix

打开Motrix - 进阶设置 - RPC。你可以看到RPC监听端口（默认为16800），和一个RPC授权密钥（随机的）
![](https://eo-r2.afo.im/myblog/img/53e255cf-965f-441d-a47a-81e20f272256.webp)
...
![](https://eo-r2.afo.im/myblog/img/0f4a510b-378a-45ab-a35f-88cfa53593e3.webp)

最后，右键扩展，勾选上下载拦截，然后尝试进行下载。如果一切顺利，浏览器的下载将被Aria2 Explorer捕获并且发送给Motrix。你可以在**Aria2 Explorer**和**Motrix**处看到下载中的文件

![](https://eo-r2.afo.im/myblog/img/57fa7b18-541e-4115-a160-cd742735e298.webp)
