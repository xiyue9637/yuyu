...
image: https://eo-r2.2x.nz/myblog/img/ee29b679-3355-453e-917b-2b85ae9106a0.webp
...
![](https://eo-r2.2x.nz/myblog/img/47f3db05-48bf-4382-817b-7a2b733dcd72.webp)

![](https://eo-r2.2x.nz/myblog/img/3ffb0585-eb36-46fe-b32a-0162514e6e63.webp)

启用插件。可以看到 `插件初始化完毕，共载入 455 个表情。` 

![](https://eo-r2.2x.nz/myblog/img/50da2a0d-7e49-491a-bad3-d9fde22a9df6.webp)

## 使用

向Bot发送 `表情列表` 

![](https://eo-r2.2x.nz/myblog/img/ed053d82-535e-47af-ac17-b27025d25dab.webp)

生成表情

![](https://eo-r2.2x.nz/myblog/img/572c88c4-301b-4048-81bf-fcbb70d4064e.webp)
